 ...
 */
package com.backPortfolio.Ludmila.security.entity;
...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal build(User user) {
        List<GrantedAuthority> authorities = user.getRoles().stream()
                ...
                .toList());
        return new UserPrincipal(user.getNombre(), user.getNombreUsuario(), user.getEmail(), user.getPassword(), authorities);
    }
